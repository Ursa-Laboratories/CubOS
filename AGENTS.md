...
`docs/agent-index.md` is the detailed retrieval map for gantry, deck, protocol, instrument, calibration, and setup work. Keep long source lists there, not here.
