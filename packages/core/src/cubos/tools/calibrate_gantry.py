...
Examples:
    ...
    python -m cubos.tools.calibrate_gantry ../BU-Configs/configs/gantry/cub_xl_asmi.yaml
...
from cubos.tools.calibration.multi_instrument_calibration import (  # noqa: E402
...
def _print_end_summary(
    ...
    *,
    ...
    output("  python -m cubos.tools.validate_setup <calibrated-gantry.yaml> <deck.yaml> <protocol.yaml>")
