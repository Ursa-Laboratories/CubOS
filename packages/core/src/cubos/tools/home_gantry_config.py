...
coordinates; use ``packages/core/src/cubos/tools/calibrate_gantry.py`` for deck-origin WPos
calibration.
...
Usage::
    ...
    python -m cubos.tools.home_gantry_config --gantry ../BU-Configs/configs/gantry/cub_xl_asmi.yaml
"""
