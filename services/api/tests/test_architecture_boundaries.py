"""Architecture guardrails for the CubOS API wrapper boundary."""
...
ROUTERS_ROOT = PROJECT_ROOT / "src" / "cubos_api" / "routers"


def test_api_routers_do_not_own_gantry_session_primitives() -> None:
    # NOTE: `threading.Lock` is deliberately allowed in gantry.py as of the
    # backend session-safety hardening pass. It guards two CubOS-level,
