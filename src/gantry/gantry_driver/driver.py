...
class Mill:
    ...
    Methods:
        ...
        current_coordinates(): Get the current work coordinates of the mill.
        move_to_position(x, y, z, coordinates, travel_z): Move the mill to the specified coordinates, optionally via a given XY-travel Z.
    """
