        ...
        <div style={headerStyle}>
          <div>
            ...
            <div style={{ marginTop: 3, fontSize: 12, color: theme.color.textMuted }}>
              {filename || "No file selected"} · {instruments.length === 0 ? "no instruments configured" : isMulti ? "multi-instrument board" : originPolicy === "home_origin" ? "single-instrument home origin" : "single-instrument deck origin"}
            </div>
          </div>
            ...
            {step === 0 && (
              <div>
                ...
                {instruments.length === 0 && (
                  <div style={noInstrumentsNoticeStyle}>
...
const noInstrumentsNoticeStyle: React.CSSProperties = {
